  ...
  <body>
    ...
    <div class="container">
      <form name="form1" method="post" action="" class="form-signin">
        <h2 class="form-signin-heading">Miptovta</h2>
        <label>usuario rafael</label>
        <input type="text" name="usuario" class="input-block-level" placeholder="Usuario"><label>clave 1234</label>
